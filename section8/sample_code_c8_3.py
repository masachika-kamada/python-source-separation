...
print(
    "処理時間[sec]: {:.2f}  {:.2f}  {:.2f}  {:.2f}".format(
        ica_time - iva_ip_time, iva_ip_time - ilrma_ip_time, iva_time - start_time, ilrma_ip_time - iva_time
    )
)
print(
    "Δsnr [dB]: {:.2f}  {:.2f}  {:.2f}  {:.2f}".format(
        snr_ica_post - snr_pre, snr_iva_post - snr_pre, snr_iva_ip_post - snr_pre, snr_ilrma_ip_post - snr_pre
    )
)
