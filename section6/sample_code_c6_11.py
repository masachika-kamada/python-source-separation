...
# 畳み込んだ波形をファイルに書き込む
write_file_from_time_signal(multi_conv_data[0, n_noise_only:] * np.iinfo(np.int16).max / 20.0, "./maxsnr_in.wav", sample_rate)
...
# 大きさを調整する
maxsnr_out = maxsnr_out * np.iinfo(np.int16).max / 20.0
