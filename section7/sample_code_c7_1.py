...
# ファイルに書き込む
write_file_from_time_signal(y_phase_left * np.iinfo(np.int16).max / 20.0, "./far_sparse_phase_left.wav", sample_rate)
write_file_from_time_signal(y_phase_right * np.iinfo(np.int16).max / 20.0, "./far_sparse_phase_right.wav", sample_rate)
write_file_from_time_signal(y_amp_left * np.iinfo(np.int16).max / 20.0, "./far_sparse_amp_left.wav", sample_rate)
write_file_from_time_signal(y_amp_right * np.iinfo(np.int16).max / 20.0, "./far_sparse_amp_right.wav", sample_rate)
