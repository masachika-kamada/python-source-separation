...
# ファイルに書き込む
write_file_from_time_signal(y_doa_left * np.iinfo(np.int16).max / 20.0, "./sparse_doa_left.wav", sample_rate)
write_file_from_time_signal(y_doa_right * np.iinfo(np.int16).max / 20.0, "./sparse_doa_right.wav", sample_rate)
