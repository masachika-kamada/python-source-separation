...
Rlgm_mm_dereverb, vlgm_mm_dereverb, y_lgm_mm_dereverb, cost_buff_lgm_mm_dereverb = execute_mm_lgm_dereverb(
    stft_data, x_bar, Ns=n_sources, n_iterations=n_ica_iterations
)
...
snr_lgm_mm_dereverb_post1 = calculate_snr(multi_conv_data_left_no_noise[0, ...], y_lgm_mm_dereverb[0, ...]) + calculate_snr(
    multi_conv_data_right_no_noise[0, ...], y_lgm_mm_dereverb[1, ...]
)
snr_lgm_mm_dereverb_post2 = calculate_snr(multi_conv_data_left_no_noise[0, ...], y_lgm_mm_dereverb[1, ...]) + calculate_snr(
    multi_conv_data_right_no_noise[0, ...], y_lgm_mm_dereverb[0, ...]
)

snr_lgm_mm_dereverb_post = np.maximum(snr_lgm_mm_dereverb_post1, snr_lgm_mm_dereverb_post2)
snr_lgm_mm_dereverb_post /= 2.0
...
write_file_from_time_signal(y_lgm_mm_dereverb[0, ...] * np.iinfo(np.int16).max / 20.0, "./lgm_mm_dereverb_1.wav", sample_rate)
write_file_from_time_signal(y_lgm_mm_dereverb[1, ...] * np.iinfo(np.int16).max / 20.0, "./lgm_mm_dereverb_2.wav", sample_rate)
